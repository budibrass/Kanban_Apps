                    ...
                    <Row>
                        <Col span={8} style={{ padding: "0 10px" }}>
                            <div className="site-card-border-less-wrapper">
                                <Card headStyle={{ backgroundColor: "#f7dce5" }} style={{ borderRadius: "5px", backgroundColor: "white", overflowY: "scroll", height: "75vh", boxShadow: "5px 8px 24px 5px rgba(208, 216, 243, 0.6)"  }} bordered={false} title="Backlog" bordered={false} extra={ <PlusCircleTwoTone onClick={handleModalAdd} style={{ fontSize : "25px", backgroundColor: "#f7dce5" }} />}>
                                {dataKanban.map((e) => {
